...
<li class="d-flex flex-justify-start flex-items-center p-0 f5 navigation-item js-navigation-item js-jump-to-global-search d-none" role="option">
  ...
  <span class="author" itemprop="author"><a class="url fn" rel="author" data-hovercard-type="organization" data-hovercard-url="/orgs/tc39/hovercard" href="/tc39">tc39</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a data-pjax="#js-repo-pjax-container" href="/tc39/proposals">proposals</a></strong>
...
<details class="details-reset details-overlay select-menu branch-select-menu">
  ...
  <details-menu class="select-menu-modal position-absolute" style="z-index: 99;" src="/tc39/proposals/ref-list/master/stage-0-proposals.md?source_action=show&amp;source_controller=blob" preload>
  ...
  <div class="Box Box--condensed d-flex flex-column flex-shrink-0">
    ...
    <li class="Box-row">
      <a class="link-gray-dark no-underline" href="/jasonwilliams">
        <img class="avatar mr-1" alt="" src="https://avatars1.githubusercontent.com/u/936006?s=40&amp;v=4" width="20" height="20" />
        jasonwilliams
</a>    </li>
    <li class="Box-row">
...
</a>    <a class="avatar-link" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=1560301" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/tc39/proposals/commits/master/stage-0-proposals.md?author=loklaan">
